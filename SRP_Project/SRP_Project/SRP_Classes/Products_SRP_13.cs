...
{
	public class Products_SRP_13
	{
        public List<int> ProductsIDList = new List<int>();
		
		public Products_SRP_13()
		{
			if (!FileService_SRP_13.FileControl("ProductsIDList.txt")) return;
			ProductsIDList = FileService_SRP_13.ReadingFile("ProductsIDList.txt");
		}
