...
{
	public class Products_OCP_13
    {
        public List<int> ProductsIDList = new List<int>();
		
		public Products_OCP_13()
		{
			if (!FileService_OCP_13.FileControl("ProductsIDList.txt")) return;
			ProductsIDList = FileService_OCP_13.ReadingFile("ProductsIDList.txt");
		}
